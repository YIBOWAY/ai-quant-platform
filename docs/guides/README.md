...
- [Paper Strategy Sleeves MVP-1](../design/paper_strategy_sleeves_plan.md) — 策略资金段 / signal-only / allocated 分账设计。2026-06-26 已完成第一切片后端基础；API、CLI、前端入口和自动成交尚未实现。执行状态见 [Paper Strategy Sleeves 执行说明](../execution/paper_strategy_sleeves.md)。
