...
| `/experiments` | Run provider-selectable experiment sweeps with optional walk-forward folds, inspect comparisons, and send best params with the same source to backtest. |
