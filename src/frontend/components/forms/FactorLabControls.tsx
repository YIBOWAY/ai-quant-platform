...
const copy = {
  en: {
    ...
    apply: "Apply",
    applying: "Applying...",
    hint: "Changes the read-only diagnostics query below. Futu = real data (requires OpenD).",
  },
  zh: {
    provider: "数据源",
    universe: "股票池",
    ...
    apply: "应用",
    applying: "应用中...",
    hint: "调整下方只读体检的查询。futu = 真实数据（需 OpenD 在线）。",
  },
} as const;
...
export function FactorLabControls({
  ...
  locale: Locale;
  initial: { provider: string; universeId: string; symbol: string; benchmarkSymbol: string };
