  ...
  return (
    <form className="flex flex-col gap-4" onSubmit={(event) => event.preventDefault()}>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <label className="flex flex-col gap-1 font-body-sm text-text-primary">
          Quantiles
          <input className="rounded border border-border-subtle bg-surface-muted px-2 py-2 font-data-mono text-text-primary" type="number" {...form.register("quantiles", { valueAsNumber: true })} />
        </label>
      </div>
