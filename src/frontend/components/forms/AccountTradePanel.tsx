...
const copy = {
  en: {
    ...
    rebalanceTitle: "Advanced Full-Account Rebalance",
    rebalanceDesc:
      "Legacy whole-account path. It applies target weights to the entire paper account; Strategy Sleeves use the separate signal panel.",
    strategy: "Strategy",
    candidates: "Candidate Symbols",
    topN: "Top N",
    lookback: "Lookback",
    rebalance: "Run full-account rebalance",
  ...
  zh: {
    ...
    checkPending: "检查挂单",
    checkingPending: "检查中...",
    rebalanceTitle: "高级全账户再平衡",
    rebalanceDesc:
      "旧的全账户路径，会把目标权重应用到整个模拟账户；策略袖珍仓请使用独立信号面板。",
    strategy: "策略",
    candidates: "候选标的",
    topN: "持仓数 Top N",
    lookback: "回看窗口",
