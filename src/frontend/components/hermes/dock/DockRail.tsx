...
export function DockRail({
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 right-0 top-[var(--spacing-topbar-height)] z-20 flex w-[var(--spacing-dock-rail)] flex-col items-center gap-1 border-l border-border-subtle bg-bg-surface py-2"
