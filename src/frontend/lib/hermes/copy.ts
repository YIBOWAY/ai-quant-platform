...
const en: HermesWorkbenchCopy = {
  ...
  today: {
    ...
    skeleton: {
      overview: "Loading today overview…",
      secondary: "Loading results and automation…",
    },
  },
};
...
/**
 * UI-1 Direction A: command kind → human title dictionary (frontend copy
 * layer, per demo data-contract §3). Unknown kinds pass through unchanged.
 */
