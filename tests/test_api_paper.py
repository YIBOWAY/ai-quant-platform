...
from quant_system.config.settings import ApiKeySettings, DataSettings, SafetySettings, Settings
...
def test_paper_run_rejects_explicit_provider_fetch_failure(
    tmp_path,
    monkeypatch,
) -> None:
    settings = Settings(
